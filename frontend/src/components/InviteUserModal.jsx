...
const InviteUserModal = ({ isOpen, onClose, onSuccess }) => {
    ...
    return (
        <div className="fixed inset-0 z-[999] flex items-start justify-center p-6 bg-navy-950/40 backdrop-blur-sm animate-fade-in sm:pt-20">
            <div className="bg-white/80 dark:bg-navy-950/80 backdrop-blur-2xl w-full max-w-lg rounded-[2.5rem] p-10 shadow-2xl border border-white/20 dark:border-white/10 animate-scale-in relative max-h-[85vh] overflow-y-auto custom-scrollbar">
